<?php
    ...
    if ( ! class_exists( 'PressApps_Redux_Framework_config' ) ) {

        class PressApps_Redux_Framework_config {
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        array(
                            'id' => 'logo_dark',
                            'type' => 'media',
                            'title' => __('Logo Dark Upload', 'pressapps' ),
                        ),
                        array(
                            'id' => 'logo_light',
                            'type' => 'media',
                            'title' => __('Logo Light Upload', 'pressapps' ),
                        ),
                        array(
                            'id' => 'favicon',
                            'type' => 'media',
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
                        ...
                        array(
                            'id'       => 'search_analytics',
                            'type'     => 'switch',
                            'title'    => __( 'Search Analytics', 'pressapps' ),
                            'desc'     => __( 'Enable to save user search data for for analytics', 'pressapps' ),
                            'default'  => '1'
                        ),
                        array(
                            'id'       => 'icons_category',
                            'type'     => 'switch',
                            'title'    => __( 'Category Icons', 'pressapps' ),
                            'desc'     => __( 'Enable category icons (Assign icons to categoies under Posts >> Categories and Posts >> Actions).', 'pressapps' ),
                            'default'  => '1'
                        ),
                        array(
                            'id'       => 'icons_post_format',
                            'type'     => 'switch',
                            'title'    => __( 'Post Format Icons', 'pressapps' ),
                            'desc'     => __( 'Enable post format icons.', 'pressapps' ),
                            'default'  => '1'
                        ),
                        array(
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'desc'     => __( 'Default featured top and bottom padding in px.', 'pressapps' ),
                            'default'  => array(
                                'padding-top'    => '5px',
                                'padding-bottom' => '5px',
                            )
                        ...
                        array(
                            ...
                            'desc'        => __( 'Display a search form in the featured.', 'shoestrap' ),
                            'options'   => array(
                                '0' => 'Disabled',
                                '1' => 'WP Search',
                                '2' => 'Live Search',
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
                        ...
                        array(
                            'id'       => 'print',
                            'type'     => 'switch',
                            'title'    => __( 'Print Button', 'pressapps' ),
                            'desc'     => __( 'Display print button on article page.', 'pressapps' ),
                            'default'  => '1'
                        ),
                        array(
                            'id'       => 'style_ol',
                            'type'     => 'switch',
                            'title'    => __( 'Ordered List', 'pressapps' ),
                            'desc'     => __( 'Style ordered lists on single pages.', 'pressapps' ),
                            'default'  => 1
                        ),
                        array(
                            'id'       => 'article_voting',
                            'type'     => 'button_set',
                            'title'    => __( 'Article Voting', 'pressapps' ),
                            'options'  => array(
                                '1' => 'Public Voting',
                        ...
                        array(
                            'id'       => 'reset_all_votes',
                            'type'     => 'button_set',
                            'title'    => __( 'Reset All Article Votes', 'pressapps' ),
                            'desc'     => __( 'Reset votes on all articles!', 'pressapps' ),
                            'options'  => array(
                                '1' => 'Reset All Votes'
                            ),
                            'multi'    => true,
                        ...
                        array(
                            'id'       => 'related_articles',
                            'type'     => 'button_set',
                            'title'    => __( 'Related Articles', 'pressapps' ),
                            'options'  => array(
                                '1' => 'Related by Tag',
                        ...
                        array(
                            'id'       => 'call_to_action',
                            'type'     => 'editor',
                            'title'    => __( 'Call To Action Content', 'pressapps' ),
                        ...
                        array(
                            'id'       => 'cta_bg',
                            'type'     => 'color',
                            'title'    => __( 'Call To Action Background', 'pressapps' ),
                            'transparent' => false,
                            'default'  => '#fbfbfb',
                            'validate' => 'color',
                            'mode'     => 'background',
                ...
                $this->sections[] = array(
                    ...
                    'fields'     => array(
                        ...
                        array(
                            ...
                            'transparent' => false,
                            'validate' => 'color',
                            'output'   => array( '.content-info, .content-info a, .content-info a:hover, .content-info i' ),
                        ),
                        array(
...
*/
                $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'transparent' => false,
                            'validate' => 'color',
                            'output'   => array( '.entry-meta, .entry-meta a' ),
                        ),
                    )
                );
            ...
            public function setArguments() {
                ...
                $this->args['admin_bar_links'][] = array(
                    ...
                    'title' => __( 'Support', 'pressapps' ),
                );

                $this->args['admin_bar_links'][] = array(
                    'id'    => 'redux-extensions',
                    'href'   => 'reduxframework.com/extensions',
                    'title' => __( 'Extensions', 'pressapps' ),
                );
        ...
        global $reduxConfig;
        $reduxConfig = new PressApps_Redux_Framework_config();
    } else {
        echo "The class named PressApps_Redux_Framework_config has already been called. <strong>Developers, you need to prefix this class with your company name or you'll run into problems!</strong>";
    }
